const addresses = {
	tokens: {
		...
		CHARILE: "0x5FC8d32690cc91D4c39d9d3abcBD16989F875707",
		DELTA: "0x0165878A594ca255338adfa4d48449f69242Eb8F",
	},
	pools: {
		"ALPHA/BETA": "0x9bd03768a7DCc129555dE410FF8E85528A4F88b5",
		"BETA/CHARILE": "0x440C0fCDC317D69606eabc35C0F676D1a8251Ee1",
		"ALPHA/CHARILE": "0x80E2E2367C5E9D070Ae2d6d50bF0cdF6360a7151",
		"ALPHA/DELTA": "0x0433d874a28147DB0b330C000fcC50C0f0BaF425",
	},
...
/**
 * Get all pool addresses and their names.
 * @returns {Array<{ name: string, address: string }>} - Array of pool name-address pairs.
 */
function getAllPools() {
	return Object.entries(addresses.pools).map(([name, address]) => ({
		name,
		address,
	}));
}
...
/**
 * Get pool by its address.
 * @param {string} address - The pool address.
 * @returns {string|null} - The pool name or null if not found.
 */
